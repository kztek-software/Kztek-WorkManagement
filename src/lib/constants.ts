export const STATUSES = [
  { id: "BACKLOG", label: "Tồn đọng (Backlog)", color: "#94a3b8" },
  { id: "TODO", label: "Cần làm", color: "#6366f1" },
  { id: "IN_PROGRESS", label: "Đang thực hiện", color: "#f59e0b" },
  { id: "IN_REVIEW", label: "Đang xét duyệt", color: "#a855f7" },
  { id: "DONE", label: "Hoàn thành", color: "#10b981" },
] as const;

export const PRIORITIES = [
  { id: "URGENT", label: "Khẩn cấp", color: "#F05922", icon: "flame" },
  { id: "HIGH", label: "Cao", color: "#f97316", icon: "arrow-up" },
  { id: "MEDIUM", label: "Trung bình", color: "#eab308", icon: "equal" },
  { id: "LOW", label: "Thấp", color: "#94a3b8", icon: "arrow-down" },
] as const;

export const TASK_TYPES = [
  { id: "TASK", label: "Công việc", color: "#3b82f6" },
  { id: "STORY", label: "Tính năng", color: "#10b981" },
  { id: "BUG", label: "Lỗi phát sinh", color: "#F05922" },
  { id: "EPIC", label: "Hạng mục lớn (Epic)", color: "#a855f7" },
] as const;
